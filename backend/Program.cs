        ...
        else
        {
            ...
            if (databaseCreator != null)
            {
                ...
                if (!tableExists)
                {
                    ...
                    // Ensure the Users table is created if it doesn't exist when database already exists
                    ...
                    createTableCommand.CommandText = @"
                        ...
                        -- Ensure UserId column exists in all user-specific tables and references Users
                    ...
                    Console.WriteLine("Users table and table relationships check/creation completed.");
            }
        }
